    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background text-foreground overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -inset-10 opacity-30 dark:opacity-50">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl"></div>
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-chart-2/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl"></div>
          <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-chart-1/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl "></div>
        </div>
      </div>
