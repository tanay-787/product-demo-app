...
export type FieldType = 'ID' | 'String' | 'Int' | 'Float' | 'Boolean' | 'DateTime' | 'Json' | 'Bytes' | 'Relation';
...
export interface FieldConfig {
  ...
  relationToModelId?: string; // Only if type is 'Relation', refers to ModelConfig.id
  relationName?: string; // Optional, for explicit relation naming
}
  ...
  models: [
    {
      ...
      fields: [
        ...
        { id: uuidv4(), name: "email", type: "String", isRequired: true, isUnique: true },
        { id: uuidv4(), name: "passwordHash", type: "String", isRequired: true },
        { id: uuidv4(), name: "role", type: "String", isRequired: true, defaultValue: "'user'" },
        { id: uuidv4(), name: "createdAt", type: "DateTime", isRequired: true, defaultValue: "now()" },
        { id: uuidv4(), name: "updatedAt", type: "DateTime", isRequired: true, defaultValue: "now()" },
      ],
    },
    {
      id: uuidv4(),
      ...
      fields: [
        { id: uuidv4(), name: "id", type: "ID", isRequired: true, isUnique: true },
        { id: uuidv4(), name: "name", type: "String", isRequired: true },
        { id: uuidv4(), name: "description", type: "String", isRequired: false },
        { id: uuidv4(), name: "price", type: "Float", isRequired: true },
        { id: uuidv4(), name: "stock", type: "Int", isRequired: true, defaultValue: "0" },
        { id: uuidv4(), name: "createdAt", type: "DateTime", isRequired: true, defaultValue: "now()" },
        { id: uuidv4(), name: "updatedAt", type: "DateTime", isRequired: true, defaultValue: "now()" },
      ],
    },
    {
      ...
      fields: [
        { id: uuidv4(), name: "id", type: "ID", isRequired: true, isUnique: true },
        { id: uuidv4(), name: "userId", type: "String", isRequired: true, relationToModelId: "USER_MODEL_ID_PLACEHOLDER", relationName: "UserOrders" }, // Placeholder for actual User ID
        { id: uuidv4(), name: "totalAmount", type: "Float", isRequired: true },
        { id: uuidv4(), name: "status", type: "String", isRequired: true, defaultValue: "'pending'" },
        { id: uuidv4(), name: "createdAt", type: "DateTime", isRequired: true, defaultValue: "now()" },
      ],
    },
  ],
  resources: [
    {
      ...
      endpoints: [
        ...
        },
        {
          ...
          pathParams: [{ id: uuidv4(), name: "id", type: "string", in: "path", required: true }],
          queryParams: [],
          authorization: "user",
          isBackgroundTask: false,
        },
